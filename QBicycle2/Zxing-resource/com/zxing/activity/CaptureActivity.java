...
public class CaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			// Intent resultIntent = new Intent(Utils.ACTION_CAPTER_BROADCAST);
			// Bundle b = new Bundle();
			// b.putString("SCAN_RESULT", resultString);
			...
			BusProvider.getInstance().post(
					new ScanEvent(getIntent().getIntExtra(Utils.REQUEST_CODE,
							-1), resultString));
		}
